        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div><a href="/supply/create" class="btn btn-primary" role="button">Tambah</a></div>
                        <br />
                                ...
                                @foreach($data as $data)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                                <a href="/supply/{{ $data->id }}/edit"><button class="btn btn-warning">Update</button></a>
                                                <form action="/supply/{{$data->id}}" method="post" style="display: inline">
                                                    @csrf
                                                    @method('DELETE')
